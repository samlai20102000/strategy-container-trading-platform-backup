...
async function executeSignalRainbowTrendLadder(
  ...
  if (action === "close") {
    ...
    await createTrade({
      ...
      orderType: "market",
      orderId: result.orderId,
      ...tradeFillRecordFields(result, exitPrice || undefined, state.totalSize, pnl),
      reduceOnly: true,
      status: "filled",
...
async function executeSignalRainbow20415(
  ...
  if (action === "close") {
    ...
    await createTrade({
      ...
      orderType: "market",
      orderId: result.orderId,
      ...tradeFillRecordFields(result, currentPrice, state.totalSize, pnl),
      reduceOnly: true,
      status: "filled",
      triggerSource: "webhook",
    });
  ...
  if (decision.action === "CLOSE_ALL") {
    ...
    if (result.success) {
      ...
      await createTrade({
        ...
        orderType: "market",
        orderId: result.orderId,
        ...tradeFillRecordFields(result, undefined, state.totalSize || 0, pnlV35),
        reduceOnly: true,
        status: "filled",
        triggerSource: "webhook",
      });
  ...
  if (decision.action === "CLOSE_ALL") {
    ...
    if (result.success) {
      ...
      await createTrade({
        ...
        orderType: "market",
        orderId: result.orderId,
        ...tradeFillRecordFields(result, undefined, state.totalSize, pnlV50),
        reduceOnly: true,
        status: "filled",
        triggerSource: "webhook",
      });
  ...
  if (decision.action === "CLOSE_ALL") {
    ...
    if (result.success) {
      ...
      await createTrade({
        ...
        orderType: "market",
        orderId: result.orderId,
        ...tradeFillRecordFields(result, undefined, state.totalSize, pnlV61),
        reduceOnly: true,
        status: "filled",
        triggerSource: "webhook",
      });
...
async function executeSignalV25(
  ...
  if (signal.action === "close") {
    ...
    await createTrade({
      ...
      orderType: "market",
      orderId: result.orderId,
      ...tradeFillRecordFields(result, signal.price, state.totalSize, realizedPnl),
      reduceOnly: true,
      status: "filled",
      triggerSource: "webhook",
    });
  ...
  if (decision.action === "CLOSE_ALL") {
    ...
    if (result.success) {
      ...
      await createTrade({
        ...
        orderType: "market",
        orderId: result.orderId,
        ...tradeFillRecordFields(result, undefined, state.totalSize, pnl),
        reduceOnly: true,
        status: "filled",
        triggerSource: "webhook",
      });
